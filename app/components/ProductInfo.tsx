...
import { addToWishlist, clearWishlist } from "@/lib/features/wishlist/productWishlistSlice";
    ...
    <div className="w-full font-montserrat">
      ...
      <div className="mt-7 mb-6">
        <p className="flex items-center border border-gray-500 gap-5 w-32 py-2 px-6">
          ...
          <span className="text-xl cursor-pointer bg" onClick={handleIncrement}>
            <AiOutlinePlus />
          </span>
        </p>
      </div>
      ...
      {/* Custom button */}
      <div className="mt-24 flex flex-col md:flex-row items-center gap-4">
        <CustomButton
          variant="outlined"
          onClick={handleColourChange}
          className=""
